...
import { v as parseRedirect, w as mergeHeaders, l as isRedirect, s as resolveManifestAssetLink, j as rootRouteId, x as defineHandlerCallback, y as getNormalizedURL, z as getOrigin, A as attachRouterServerSsrUtils, C as createSerializationAdapter, D as createRawStreamRPCPlugin, i as invariant, g as isNotFound, E as isResolvedRedirect, F as executeRewriteInput, G as defaultSerovalPlugins, H as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C4U3Fn0g.mjs");
...
const manifest = {
  ...
  "34f16eb07e6f32e162b25bb5273f373be9baf59ba8fcf4a6aebee4a1ade51de0": {
    functionName: "logPaymentFailure_createServerFn_handler",
    importer: () => import("./razorpay.functions-DppCnuEQ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ooRAjpbC.mjs").then((n) => n.r),
    import("./start-BEag-pPm.mjs"),
