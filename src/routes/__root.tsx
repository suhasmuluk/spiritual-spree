...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VedaKits — Authentic Astro & Wellness Essentials" },
      { name: "description", content: "VedaKits curates authentic Vedic Astro kits and natural Wellness essentials — Vastu kits, Pooja kits, bathing salts, moringa powder and more." },
      { name: "author", content: "VedaKits" },
      { property: "og:title", content: "VedaKits — Authentic Astro & Wellness Essentials" },
      { property: "og:description", content: "Authentic Vedic Astro kits and natural Wellness essentials, curated with care." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "VedaKits — Authentic Astro & Wellness Essentials" },
      { name: "twitter:description", content: "Authentic Vedic Astro kits and natural Wellness essentials, curated with care." },
